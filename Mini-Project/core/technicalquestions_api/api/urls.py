...
urlpatterns = [
    ...
    path('question/generate/', GenerateTechnicalQuestionsView.as_view(), name='generate-technical-questions'), # route changed from questions to question to avoid url match error
]